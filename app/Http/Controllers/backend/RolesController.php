...
//activity Log
$log = ['module'=>'Role', 'action' =>'Role Created' , 'description'=> 'New Role Created : '.$request->name];
captureActivity($log);
    ...
    public function update(Request $request)
    {
        ...
        if($role->getChanges()){
            ...
            $str = ['module'=>'role', 'action' =>'role Update' , 'description'=> 'role Updated : '.$original_cat];
    ...
    public function destroy($id)
    {
        ...
        if($role->delete()){
            ...
            $log = ['module'=>'role', 'action' =>'role Deleted' , 'description'=> 'role deleted : role Name  = '.$role->name];
            captureActivity($log);
            //activity lo
        }
