...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h4 class="content-header-title font-weight-bold">Create Category</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('visibility', ['0'=>'Inactive' , '1' => 'Active'] , 1, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Select Visibility']) }}
                                        </div>
                                    </div>

                                    <div class="col-md-6 col-12">
                                        {{ Form::label('has subcategory', 'has Subcategory') }}<br>
                                        Yes{{ Form::radio('sub_category', '1' , true) }}
                                        No {{ Form::radio('sub_category', '0' , false) }}
