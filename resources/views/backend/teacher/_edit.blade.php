                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mt-1 mb-2">
                                                <div class="form-group">
                                                    {{ Form::label('edu_details', 'Education Details *') }}
                                                    {{ Form::textarea('edu_details', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Enter education details *', 'style'=>'resize:none', 'rows'=>3, 'cols'=>'12']) }}
                                                </div>
                                            </div>
