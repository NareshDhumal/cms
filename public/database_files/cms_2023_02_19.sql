...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 19, 2023 at 05:56 PM
...
CREATE TABLE IF NOT EXISTS `student_admissions` (
  `student_admission_id` int(11) NOT NULL AUTO_INCREMENT,
  `student_id` int(11) DEFAULT NULL,
  `year_id` varchar(255) DEFAULT NULL,
  `batch_id` int(11) DEFAULT NULL,
  `fees` float DEFAULT NULL,
  `discounted_fees` float DEFAULT NULL,
  `inserted_by` int(11) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`student_admission_id`)
...
(91, 1, 'admin user', 'Oja7VgKHBTebcqmau3koVuPCSF6xBGKZoAUvLzF8', '2023-02-19 04:34:09', NULL, '2023-02-19 04:34:09', '2023-02-19 04:34:09', NULL),
(92, 1, 'admin user', 'J8hpNw6odW22pOwiuNaauHYoCAF7TZ4tagNWXzCH', '2023-02-19 10:08:13', NULL, '2023-02-19 10:08:13', '2023-02-19 10:08:13', NULL),
(93, 1, 'admin user', 'uwYhl6YgNFKpUU8dyRfzbnm3E9ctAzirhx88kltC', '2023-02-19 14:44:29', NULL, '2023-02-19 14:44:29', '2023-02-19 14:44:29', NULL);
COMMIT;
